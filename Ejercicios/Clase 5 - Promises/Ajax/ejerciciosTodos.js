(function(){
	...
	callMyNumbers1()
		...
		.then(addResults)
		.then(alertResults)
		.then(messurePerformance("Ejercicio 1"));
		
	//Ejercicio 2
	Promise.all([callMyNumbers1(), callMyNumbers2()])
		.then(addResults)
		.then(alertResults)
		.then(messurePerformance("Ejercicio 2"));
	...
	//Ejercicio 4
	Promise.all([callMyNumbers1(), callMyNumbers2(), callMyNumbers3()])
		.then(addResults)
		.then(alertResults)
		.catch(handleError)
		.then(messurePerformance("Ejercicio 4"));
